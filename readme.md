...
1. Атоматическое применение Liquid-синтаксиса для `.html` и `.md` файлов.
1. Работает только проектах, где это настроено (не мешает в других проектах).
