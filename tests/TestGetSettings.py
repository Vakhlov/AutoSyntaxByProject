...
class TestGetSetting(unittest.TestCase):
	...
	def testReturnsValueFromSettings(self):
		"""
	...
	def testFallsBackToDefault(self):
		"""
	...
	def testFallsBackToDefaultDict(self):
		"""
	...
	def testReturnsNoneForUnknownKey(self):
		"""
	...
	def testLoadSettingsCalledWithPluginName(self):
		"""
